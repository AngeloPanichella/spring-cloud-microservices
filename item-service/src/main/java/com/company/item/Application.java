...
public class Application {
    ...
    public Docket api() throws IOException, XmlPullParserException {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build().apiInfo(new ApiInfo("Item Api Documentation", "Documentation automatically generated", getClass().getPackage().getImplementationVersion(), null, new Contact("company Team", "www.company.com", "company@gmail.com"), null, null));
    }
}
